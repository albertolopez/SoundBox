...
if(!empty($_GET['id'])) {
	...
	$title = _('Soundbox: comentarios') . " [$id]";
	...
	$title = _('Soundbox: comentarios de ') . $username;
	$globals['redirect_feedburner'] = false;
	...
	$title = _('Soundbox: conversación de ') . $username;
	$globals['redirect_feedburner'] = false;
	...
	$title = _('SoundBox: comentarios noticias de ') . $username;
	$globals['redirect_feedburner'] = false;
	...
	$title = _('Soundbox: respuestas a ') . $username;
	$globals['redirect_feedburner'] = false;
} else {
	//
	// All comments
